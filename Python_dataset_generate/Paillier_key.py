...
# add parsor for self define argument
import argparse
...
if __name__ == "__main__":
    ...
    public_key_file = f'paillier_public_key.txt'
    private_key_file = f'paillier_private_key.txt'
    pq_file = f'paillier_pq_values.txt'
