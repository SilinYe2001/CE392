...
# Generated on: Thu May 23 17:36:28 CDT 2024 (Thu May 23 22:36:28 GMT 2024)

set lec_version [regsub {(-)[A-Za-z]} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file fv/key_generation/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/key_generation -revised fv_map
...
read_design -enumconstraint  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09 ../key_generation.sv ../ModInvert.sv
elaborate_design -golden -root {key_generation} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/key_generation/fv_map.v.gz
elaborate_design -revised -root {key_generation}
...
#add_name_alias fv/key_generation/fv_map.singlebit.original_name.alias.json.gz -revised
